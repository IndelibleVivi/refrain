...
const en = {
  ...
  close: "Close",
  workAppearance: "Work presentation",
  localAppearance: "My appearance",
  appearanceOwnership:
    "The work sets the scene. Your changes are a personal listening preference, saved only on this device.",
  themeGrammar: "Visual language",
  colorPalette: "Palette",
  originalPalette: "Original",
  fineTune: "Fine-tune colors",
  backgroundPosition: "Image position",
  imageCenter: "Center",
  imageTop: "Top",
  imageBottom: "Bottom",
  backgroundFit: "Image fit",
  imageCover: "Fill canvas",
  imageContain: "Whole image",
  photoHint:
    "A quiet image works best. Adjust its strength and crop; the score keeps its own visual language.",
...
const zh: typeof en = {
  ...
  close: "关闭",
  workAppearance: "作品呈现",
  localAppearance: "我的外观",
  appearanceOwnership:
    "作品先选择呈现方式。你的调整是自己的聆听偏好，只保存在这台设备。",
  themeGrammar: "视觉语言",
  colorPalette: "配色",
  originalPalette: "原色",
  fineTune: "微调颜色",
  backgroundPosition: "照片位置",
  imageCenter: "居中",
  imageTop: "上方",
  imageBottom: "下方",
  backgroundFit: "照片裁切",
  ...
  imageContain: "保留全图",
  photoHint:
    "安静一点的照片更容易相处。调整浓度和裁切，乐谱仍保留自己的视觉语言。",
  symbolColor: "音符与符号",
  textColor: "文字",
