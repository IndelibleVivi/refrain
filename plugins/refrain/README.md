...
This directory contains a **Skill-only Codex Plugin source candidate, version 0.3.0**. It helps the current host agent compose, inspect, produce, share, and answer music through Refrain. It is not a marketplace installation or an automatically configured MCP connection, and it does not bundle the CLI runtime.
...
| Self-listening, sharing, receiving, optional response | [Musical correspondence](skills/refrain-air-authoring/references/correspondence.md)               |
